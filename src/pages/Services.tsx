                  ...
                  <div className="flex items-center justify-between gap-3 sm:gap-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className={cn(
                        ...
                        cat.id === activeCategoryId ? "bg-primary text-white" : "bg-white text-primary"
                      )}>
                        {cat.name.includes('Home') ? <Home className="w-5 h-5 sm:w-6 h-6" /> : 
                         cat.name.includes('Event') ? <Sparkles className="w-5 h-5 sm:w-6 h-6" /> : 
                         cat.name.includes('Business') ? <Briefcase className="w-5 h-5 sm:w-6 h-6" /> : <Layers className="w-5 h-5 sm:w-6 h-6" />}
                      </div>
                      <div>
                        <h4 className={cn(
        ...
        <div className="lg:flex-1 space-y-4 sm:space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-2">
            ...
            <button
              ...
              className="flex items-center gap-2 primary-gradient text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:scale-[1.02] transition-all whitespace-nowrap w-full sm:w-auto justify-center"
            >
            ...
            <div className="overflow-x-auto scrollbar-none">
              <table className="w-full text-left">
                <thead className="bg-slate-50/50 backdrop-blur-md border-b border-slate-100">
                  <tr>
                    <th className="px-5 sm:px-8 py-4 sm:py-5 text-[9px] sm:text-[11px] font-black text-slate-400 uppercase tracking-widest">Service</th>
                    <th className="px-5 sm:px-8 py-4 sm:py-5 text-[9px] sm:text-[11px] font-black text-slate-400 uppercase tracking-widest text-right">Actions</th>
                  </tr>
                </thead>
                    ...
                    {filteredServices.map((service) => (
                      ...
                      >
                        <td className="px-5 sm:px-8 py-4">
                          <span className="font-black text-slate-800 tracking-tight">{service.name}</span>
                        </td>
                    ...
                    <tr>
                      <td colSpan={2} className="px-8 py-16 text-center">
                        <div className="flex flex-col items-center">
                          <div className="w-12 h-12 bg-slate-50 rounded-full flex items-center justify-center mb-3 border border-slate-100 italic font-black text-slate-200 text-xl">!</div>
                          <p className="font-bold text-slate-400 text-xs">No services found.</p>
                        </div>
                      </td>
                    </tr>
                  )}
            ...
            >
              <div className="flex items-center justify-between mb-6 sm:mb-10">
                <div>
                  ...
                  <p className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Strategic Marketplace Governance</p>
                </div>
                <button 
                  onClick={() => setIsCategoryModalOpen(false)}
            ...
            >
              <div className="flex items-center justify-between mb-6 sm:mb-10">
                <div>
                  ...
                  <p className="text-[9px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Strategic Service Listings</p>
                </div>
                <button 
                  type="button"
                  onClick={() => setIsServiceModalOpen(false)}
              ...
              <div className="space-y-4 sm:space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-slate-100 text-slate-600 px-5 py-3.5 rounded-xl sm:rounded-2xl text-[10px] sm:text-xs font-black uppercase tracking-widest border border-slate-200">
